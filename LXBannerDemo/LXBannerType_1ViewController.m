//
//  LXBannerType_1ViewController.m
//  LXBannerDemo
//
...
@interface LXBannerType_1ViewController ()

@property (nonatomic, strong) LXBannerView *bannerView;

@end

@implementation LXBannerType_1ViewController

#pragma mark - lazy load
- (LXBannerView *)bannerView {
    if (!_bannerView) {
        _bannerView = [LXBannerView bannerViewWithFrame:CGRectMake(0, 0, kScreen_WIDTH, 200) style:LXBannerViewStyle_Loop imgArray:@[@"timg-1.jpeg", @"timg-2.jpeg", @"timg-3.jpeg", @"timg-4.jpeg", @"timg-5.jpeg"]];
...
#pragma mark - 初始化bannerType_1View
- (void)setupBannerType_1View {
